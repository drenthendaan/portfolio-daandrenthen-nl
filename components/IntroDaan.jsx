      ...
      >
        ...
        <div className="col-span-1 md:col-span-6 text-left md:text-right relative z-10 flex flex-col items-start md:items-end justify-end h-full md:mt-0">
          ...
          <div className="inline-block relative w-auto">
            {" "}
            <p
              className={`py-3 md:py-1 px-4 md:px-3 border border-black inline-flex justify-between items-center rounded-2xl cursor-pointer transition-all duration-300 w-72 hover:bg-black hover:text-white group`}
