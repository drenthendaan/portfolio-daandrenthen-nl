        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-24 gap-10">
          ...
          <div className="max-w-md">
            <p className="text-lg text-gray-600 font-light leading-relaxed">
              Mijn beste UX-projecten op een rij. Slim bedacht, mooi ontworpen en technisch goed uitgevoerd.
            </p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-16 lg:gap-x-24">
          {projecten.map((project, index) => (
            <Link
              ...
              className={`group block cursor-pointer ${index % 2 !== 0 ? "md:pt-32" : ""}`}
            >
              <div className="relative overflow-hidden rounded-[2rem] bg-black aspect-[4/3] mb-8 transition-all duration-700 ease-out group-hover:shadow-2xl group-hover:shadow-black/5">
              ...
              <div className="flex justify-between items-start gap-6 border-t border-gray-200/60 pt-6 group-hover:border-gray-400 transition-colors duration-500">
                <div className="max-w-md pb-4">
                  ...
                  <p className="text-gray-500 text-base font-light leading-relaxed line-clamp-3">
                    {project.description}
                  </p>
                </div>
                ...
                <div className="hidden md:flex items-center justify-center w-14 h-14 rounded-full border border-gray-200 group-hover:bg-black group-hover:border-black transition-all duration-500 shrink-0">
                  <svg className="w-6 h-6 text-gray-900 group-hover:text-white transform transition-transform duration-500 group-hover:-rotate-45" fill="none" viewBox="0 0 24 24" stroke="currentColor">
